            ...
            <div className="right flex-grow">
              ...
              <div className="flex gap10 mb-24">
                ...
                <div className="body-text">
                  Confirm that, according to the Envato License Terms, each
                  license entitles one person for a single project. Creating
                  multiple unregistered installations is a copyright violation.{" "}
              ...
              <div className="text-tiny tf-color-1 mb-10">
                Note: Your site IP will be added to blacklist after 5 failed
                attempts.
              </div>
              <div className="body-text">
                A purchase code (license) is only valid for One Domain. Are you
                using this theme on a new domain? Purchase a new license here to
                get a new purchase code.
              </div>
            </div>
          </div>
          <div className="wg-box">
                ...
                <div className="radio-buttons">
                  <div className="item">
                    ...
                    <label htmlFor="rich-editor1">
                      <span className="body-title-2">CKEditor</span>
                    </label>
                  </div>
                  <div className="item">
                    <input type="radio" name="rich-editor" id="rich-editor2" />
                    <label htmlFor="rich-editor2">
                      <span className="body-title-2">TinyMCE</span>
                    </label>
                  </div>
                </div>
              </fieldset>
          ...
          <div className="wg-box">
            ...
            <div className="right flex-grow">
              ...
              <div className="flex gap10 mb-24">
                <input type="checkbox" />
                <div className="body-text">
                  Show admin bar (When admin logged in, still show admin bar in
                  website)?
                </div>
              </div>
              <fieldset className="mb-24">
          ...
          <div className="wg-box">
            ...
            <div className="right flex-grow">
              ...
              <div className="block-warning type-main w-full mb-24">
                <i className="icon-alert-octagon" />
                <div className="body-title-2">
                  Blacklist contact requests if the email domain is in blacklist
          ...
          <div className="wg-box">
            ...
            <div className="right flex-grow">
              ...
              <div className="body-text mb-24">
                If using assets option is enabled then below scripts will be
                auto added to front site.
              </div>
