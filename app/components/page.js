    ...
    <>
      <Layout>
          ...
          <div className="row">
            <div className="col-xl-4 mb-20">
              <div className="wg-box h-full">
                ...
                <div className="block-warning type-main">
                  <i className="icon-alert-octagon" />
                  <div className="body-title-2">
                    Blacklist contact requests if it includes those keywords in
                    the content field (separate by comma).
                  </div>
                </div>
                  ...
                  <div className="radio-buttons">
                    <div className="item">
                      ...
                      <label htmlFor="admin-language1">
                        <span className="body-title-2">Left to Right</span>
                      </label>
                    </div>
                    <div className="item">
                      <input
                      ...
                      <label htmlFor="admin-language2">
                        <span className="body-title-2">Right to Left</span>
                      </label>
                    </div>
                  </div>
                </div>
                ...
                <div className="row">
                  <div className="col-xl-4 mb-20">
                    <div>
                      ...
                      <div className="flex items-center gap10 flex-wrap">
                        <p>
                          Use &lt;select&gt; and class .image-select.no-text
                        </p>
                  ...
                  <div className="col-xl-4 mb-20">
                    <div>
                                ...
                                <div className="noti-item w-full wg-user active">
                                  ...
                                  <div className="flex-grow">
                                    <div className="flex items-center justify-between">
                                      <Link href="#" className="body-title">
                                        Cameron Williamson
                                      </Link>
                      ...
                      <div className="flex items-center gap10 flex-wrap">
                        <p>
                          Dropdown end : add class .dropdown-menu-end in
                          ul.dropdown-menu
                        </p>
                        <div className="popup-wrap noti type-header">
                          <Menu as="div" className="dropdown">
            ...
            <div className="col-xl-4 mb-20">
              <div className="wg-box h-full">
                ...
                <div>
                  <p className="mb-10">
                    Pagination center : add class .justify-content-center
                  </p>
                ...
                <div>
                  <p className="mb-10">
                    Pagination end : add class .justify-content-end
                  </p>
                ...
                <div>
                  ...
                  <div className="widget-tabs">
                    <ul className="widget-menu-tab">
                      <li
                        className={
                          isTab1 === 1 ? "item-title active" : "item-title"
                        }
                        onClick={() => handleTab1(1)}
                      >
                        <span className="inner">
                          <span className="h6">Tabs 1</span>
                        </span>
                      </li>
                      <li
                        className={
                          isTab1 === 2 ? "item-title active" : "item-title"
                        }
                        onClick={() => handleTab1(2)}
                      >
                        <span className="inner">
                          <span className="h6">Tabs 2</span>
                        </span>
                      </li>
                    </ul>
                    <div className="widget-content-tab">
                      ...
                      >
                        <p>
                          ...
                          elit. Quo molestias saepe id dolores at sed, numquam
                          vero, amet iure reiciendis exercitationem ut
                          laudantium! Voluptas tempora architecto dicta ex a
                          eum? Neque distinctio, deleniti enim, similique
                          accusantium saepe asperiores sed aperiam tenetur
                          itaque ullam quidem qui minus culpa minima, id
                          pariatur unde. Eum, nobis? Animi consequatur et
                          dolorum distinctio veniam assumenda.
                        </p>
                      </div>
                      <div
                      ...
                      >
                        <p>
                          Lorem ipsum dolor sit amet consectetur, adipisicing
                          elit. Repellat fugit doloribus quibusdam a quae?
                          Eveniet modi obcaecati, quis a debitis minima! Optio
                          libero quam vitae expedita quisquam minus voluptatem
                          debitis? Aspernatur minima reprehenderit culpa rerum,
                          asperiores recusandae. Sunt molestias fugiat impedit,
                          porro itaque iusto dolor consectetur excepturi,
                          tenetur quae sed architecto ab explicabo voluptate at
                          modi! Expedita quisquam accusantium quas. Aliquam
                          placeat beatae iste eos optio enim in, aperiam ipsa
                          qui similique sapiente, quos exercitationem tempore,
                          obcaecati libero quas aut repellendus rerum ab vitae
                          dicta dolor a dignissimos modi. Maxime. Pariatur harum
                          mollitia numquam impedit vitae magnam quo quaerat
                          dignissimos ipsam sunt, itaque beatae, sequi velit!
                          Voluptas magni adipisci mollitia minus, veniam illo
                          excepturi commodi odit nihil tempora eum impedit.
                        </p>
                      </div>
                    </div>
                  </div>
                ...
                <div>
                  ...
                  <div className="widget-tabs">
                    <ul className="widget-menu-tab style-1">
                      <li
                        className={
                          isTab2 === 1 ? "item-title active" : "item-title"
                        }
                      ...
                      <li
                        className={
                          isTab2 === 2 ? "item-title active" : "item-title"
                        }
                  ...
                  <div className="col-12 mb-20">
                    <div className="country-item">
                      ...
                      <div className="flex-grow flex items-center justify-between">
                        <Link href="/countries" className="body-text name">
                          Turkish Flag
                        </Link>
                        <div className="box-icon-trending up">
                          <i className="icon-trending-up" />
                  ...
                  <div className="col-12 mb-20">
                    <div className="shop-item">
                      ...
                      <div className="flex-grow flex items-center justify-between gap20">
                        <div>
                          <Link href="#" className="body-text name">
                            Robert
                          </Link>
        ...
        <div
          ...
          style={{ visibility: `${isToggle1 ? "visible" : "hidden"}` }}
        >
        ...
        <div
          ...
          style={{ visibility: `${isToggle2 ? "visible" : "hidden"}` }}
        >
          <div className="offcanvas-header">
            <h6>Offcanvas</h6>
            <button
        ...
        <div
          ...
          style={{ visibility: `${isToggle3 ? "visible" : "hidden"}` }}
        >
          <div className="offcanvas-header">
            <h6>Offcanvas</h6>
            <button
        ...
        <div
          ...
          style={{ visibility: `${isToggle4 ? "visible" : "hidden"}` }}
        >
          <div className="offcanvas-header">
            <h6>Offcanvas</h6>
            <button
