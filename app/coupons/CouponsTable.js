  ...
  try {
    ...
    const filteredCoupons = searchParams?.search 
      ? coupons.filter(coupon => 
          coupon.code.toLowerCase().includes(searchParams.search.toLowerCase())
        )
      : coupons;
      ...
      <>
        <div className="wg-table table-all-coupon">
          <ul className="table-title flex gap20 mb-14">
            <li>
              <div className="body-title">Coupon Code</div>
            </li>
            <li>
              <div className="body-title">Discount</div>
            </li>
            <li>
              <div className="body-title">Valid Period</div>
            </li>
            <li>
              <div className="body-title">Usage Limits</div>
            </li>
            <li>
          ...
          <ul className="flex flex-column">
            {filteredCoupons.length === 0 ? (
              <li className="text-center py-8">
                ...
                {!searchParams?.search && (
                  <Link href="/new-coupon" className="tf-button style-1 mt-4">
                ...
                return (
                  <li className="product-item gap14" key={coupon.id}>
                    <div className="image no-bg">
                      <div className="coupon-icon" style={{
                        ...
                        background: isActive ? 'linear-gradient(135deg, #10b981, #059669)' : 
                                   isExpired ? 'linear-gradient(135deg, #ef4444, #dc2626)' : 
                    ...
                    <div className="flex items-center justify-between gap20 flex-grow">
                      <div className="name">
                        <div className="body-title-2" style={{ 
                      ...
                      <div className="body-text">
                        ...
                        <div style={{ fontSize: '12px', color: '#6b7280' }}>
                          to {validUntil.toLocaleDateString()}
                        </div>
                      </div>
                      ...
                      <div className="list-icon-function">
                        <Link href={`/coupon-detail/${coupon.id}`} className="item eye">
                          <i className="icon-eye" />
                        </Link>
                        <Link href={`/edit-coupon/${coupon.id}`} className="item edit">
    ...
    return (
      <div className="text-center py-8">
        <h3 className="text-lg font-medium text-red-600 mb-4">Error Loading Coupons</h3>
