      ...
      <div className="flex gap20 flex-wrap">
        ...
        <div className="wg-box flex-grow" style={{ minWidth: '400px' }}>
          ...
          <div className="chart-placeholder" style={{
            ...
            <p style={{ color: '#94a3b8', textAlign: 'center', maxWidth: '250px' }}>
              Chart visualization will be implemented with a charting library like Chart.js or Recharts
            </p>
          ...
          <div className="top-products-list">
            {analytics.topProducts && analytics.topProducts.length > 0 ? (
              analytics.topProducts.slice(0, 5).map((product, index) => (
                <div key={product.id} className="flex items-center justify-between mb-12 p-12" style={{
                  backgroundColor: index % 2 === 0 ? '#f8fafc' : 'transparent',
                  borderRadius: '6px'
                }}>
                  <div className="flex items-center gap10">
                    <div className="rank" style={{
                      backgroundColor: index === 0 ? '#fbbf24' : index === 1 ? '#94a3b8' : index === 2 ? '#f59e0b' : '#e5e7eb',
                    ...
                    <div>
                      <div className="body-title-2" style={{ fontSize: '14px' }}>
                        {product.name}
                      </div>
