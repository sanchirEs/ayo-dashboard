...
export default async function SalesOverview({ searchParams }) {
  try {
    ...
    const dateRange = searchParams?.days ? 
      getDateRange(parseInt(searchParams.days)) : 
      getDateRange(30);
    ...
    const salesChange = 12.5; // +12.5%
    const ordersChange = 8.3;  // +8.3%
    const avgOrderChange = 4.2; // +4.2%
      ...
      <div className="wg-box">
        <div className="flex items-center justify-between mb-20">
          ...
          <div className="flex gap10">
            <a 
              href="/sales?days=7" 
              className={`text-tiny ${searchParams?.days === '7' ? 'text-primary' : 'text-secondary'}`}
            >
              7 Days
            </a>
            <a 
              href="/sales?days=30" 
              className={`text-tiny ${!searchParams?.days || searchParams?.days === '30' ? 'text-primary' : 'text-secondary'}`}
            >
              30 Days
            </a>
            <a 
              href="/sales?days=90" 
              className={`text-tiny ${searchParams?.days === '90' ? 'text-primary' : 'text-secondary'}`}
            >
              90 Days
            </a>
          </div>
        ...
        <div className="flex gap20 flex-wrap">
          {/* Total Sales */}
          <div className="sales-card flex-grow" style={{ 
            ...
            <div className="flex items-center justify-between mb-10">
              ...
              <div className="change-indicator" style={{
                backgroundColor: salesChange > 0 ? 'rgba(34, 197, 94, 0.2)' : 'rgba(239, 68, 68, 0.2)',
          ...
          <div className="sales-card flex-grow" style={{ 
            ...
            <div className="flex items-center justify-between mb-10">
              ...
              <div className="change-indicator" style={{
                backgroundColor: ordersChange > 0 ? 'rgba(34, 197, 94, 0.2)' : 'rgba(239, 68, 68, 0.2)',
          ...
          <div className="sales-card flex-grow" style={{ 
            ...
            <div className="flex items-center justify-between mb-10">
              ...
              <div className="change-indicator" style={{
                backgroundColor: avgOrderChange > 0 ? 'rgba(34, 197, 94, 0.2)' : 'rgba(239, 68, 68, 0.2)',
                color: avgOrderChange > 0 ? '#22c55e' : '#ef4444',
                padding: '4px 8px',
                borderRadius: '12px',
                fontSize: '12px',
                fontWeight: 'bold'
