...
const EarningsChart1 = dynamic(() => import("./EarningsChart1"), {
  ssr: false,
});
const EarningsChart2 = dynamic(() => import("./EarningsChart2"), {
  ssr: false,
});
const EarningsChart3 = dynamic(() => import("./EarningsChart3"), {
  ssr: false,
});
...
const SaleDonutChart1 = dynamic(() => import("./SaleDonutChart1"), {
  ssr: false,
});
